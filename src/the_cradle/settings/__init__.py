...
from ._pal import SETTINGS__PAL
from ._quart_hd import SETTINGS__QUART_HD
from ._vga import SETTINGS__VGA

__all__ = ["SETTINGS__PAL", "SETTINGS__QUART_HD", "SETTINGS__VGA"]
