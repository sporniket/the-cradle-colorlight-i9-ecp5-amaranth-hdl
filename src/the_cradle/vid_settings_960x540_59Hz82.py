...
---
"""
## pll parameters to get the frequencies [370, 37, 123.333, 185]MHz
## ecppll -i 25 -o 370 --clkout1 37 --clkout2 123 --clkout3 185 -f foo.txt
mainPllParameters = {
